...
: Pessoa(nome, cpf_cnpj, endereco, email, tipo), matricula(matricula), nascimento(nascimento), admissao(admissao), situacao(situacao), salario(salario), departamento(departamento), cargo(cargo)
{
