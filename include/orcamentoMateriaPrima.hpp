...
public:
    ...
    {
        std::string permissao = "gerarOrcamentoMP";
        std::string atributos = "categoria, qtd e mp";
        Empresa::getEmpresa()->gerarLogEscrita("oracamentoMateriaPrima", atributos);
        if (!Empresa::getEmpresa()->verificaPermissao(permissao))
        {
            Empresa::getEmpresa()->gerarLogExcecao("oracamentoMateriaPrima", "gerarOrcamentoMP");
